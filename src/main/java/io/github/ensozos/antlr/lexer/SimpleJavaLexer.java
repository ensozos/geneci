package io.github.ensozos.antlr.lexer;// Generated from C:\Users\zosimadis\IdeaProjects\com.ensozos.classinfo.CILauncher\grammar\SimpleJava.g4 by ANTLR 4.7.2
...
public class SimpleJavaLexer extends Lexer implements ILexer {
    static {
    ...
    /**
     * Constructs an empty SimpleJavaLexer object. This costructor is not generated by antlr
     * automatically and is necessary to build the object in LanguageFactory.
     */
    public SimpleJavaLexer() {
        super(null);
        _interp = new LexerATNSimulator(this, _ATN, _decisionToDFA, _sharedContextCache);
    }
